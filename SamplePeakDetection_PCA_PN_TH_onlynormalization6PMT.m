function successmessage=SamplePeakDetection_PCA_PN_TH_onlynormalization6PMT(filepath,...
...
% equalization
% Date Modified: 04/02/2025 by Taras Hanulia (thanul01@tufts.edu)
% Normalized raw data for 6 PMT set up
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Function details
% Inputs:
