function successmessage=SamplePeakDetection_PCA_PN_6PMT(filepath,outputfile,...
...
% Written By: Nilay Vora (nvora01@tufts.edu) Taras Hanulia 
% (thanul01@tufts.edu)
...
% equalization
% Date Modified: 06/27/2023
% Modifying Author:Taras Hanulia
% Latest Revision: Modified for 6 PMT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Function details
% Inputs:
    ...
    for i=file_range
        ...
        if~isempty(subdirinfo{i})
            ...
            elseif f==2
                ...
                flr_detect_3 = 0; % E2C red Fluorescence
<<<<<<< HEAD
                 if bead_flag==1 % removed strcmp(sample_type,'Blood') && 
=======
                if strcmp(sample_type,'Blood') && bead_flag==1 
>>>>>>> 284a58e6dd74f8ddc10923cea9d8fb5f842c14e3
