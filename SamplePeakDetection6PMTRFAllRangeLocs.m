function successmessage=SamplePeakDetection6PMTRFAllRangeLocs(filepath,outputfile,...
...
% fluorescence (iRFP720, green, E2Crimson) The location of start and end of
% the peak calculated
% Written By: Taras Hanulia (thanul01@tufts.edu)
% Date Written: 08/07/2024
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Function details
% Inputs:
...
%             peak_values(:,22)=all_fwhm_fl3; peak_values(:,23)=all_peak_area_fl3;
            peak_values(:,9)=all_file_num;
            peak_values(:,10)=all_peak_start;
            peak_values(:,11)=all_peak_end;
            peak_values(1,:)=[];
...
%         peak_values(:,22)=all_fwhm_fl3_Store; peak_values(:,23)=all_peak_area_fl3_Store;
        peak_values(:,9)=all_file_num_Store;
        peak_values(:,10)=all_peak_start_Store;
        peak_values(:,11)=all_peak_end_Store;
        % Sorting peaks
        peak_values=sortrows(peak_values,7);
        delrow=peak_values(:,11)==0;
        peak_values(delrow,:)=[];
...
successmessage=PeakSortingWithFLR(filepath, file_range, bead_flag);
disp(successmessage)
successmessage=PeakSortingWithScat(filepath, file_range, bead_flag);
disp(successmessage)
