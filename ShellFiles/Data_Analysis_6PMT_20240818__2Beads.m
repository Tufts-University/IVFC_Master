...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2024\TH_081824_Calibration2';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_08_18_24_2';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
...
%% Calibration
files={
    'NEW_peak_values_08_05_24';...
    'NEW_peak_values_08_09_24';...
