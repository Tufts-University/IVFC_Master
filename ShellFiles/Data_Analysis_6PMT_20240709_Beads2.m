%% 07/09/24 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 07/09/2024 
%% Experiment Note
% beads ND 1.2 on 405 and 1.3 on 633, 1.5 on 488 slit of 405 shorter 
% new ND filter for spactralon 2.3 befor new ex ND second after small
% alligment
%% Initialization
clear
clc
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2024\TH_070924_Calibration2';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_07_09_24_2';
file_range= (3:4);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
