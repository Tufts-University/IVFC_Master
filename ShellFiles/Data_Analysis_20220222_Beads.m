...
% Flow Date: 02/22/2022
%% Experiment Note
% New PMT Configuration based on measurements from last week
% New channel (12/08), flow is adequete but new device may be needed.
%% Initialization
clear
clc
%% Calling Script
%% Bead Calibration
% Labview Conversion
filepath = 'Z:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2022\NV_022222_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%Peak Detection
outputfile= 'NEW_peak_values_02_22_22';
file_range= (1:2);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
