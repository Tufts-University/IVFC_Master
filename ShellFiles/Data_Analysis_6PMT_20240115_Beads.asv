...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2025\TH_011525_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_01_15_25_2';
file_range= (3:4);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
...
files={
    ...
    'NEW_peak_values_01_09_25_2';...
    'NEW_peak_values_01_15_25_2'};
