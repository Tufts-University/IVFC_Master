...
for i =1:3
    % Labview Conversion
    if i==1
        filepath = 'T:\Nilay\IVFC\Acquired Data\SydneyMice\NV_070622_LeanCancer';
    else
        filepath = ['T:\Nilay\IVFC\Acquired Data\SydneyMice\NV_070622_LeanCancer',num2str(i)];
    end
    Fs=60e3;
    Window_Low= 50;
    Window_High= 6000;
    ...
    %Peak Detection
    outputfile= 'NEW_peak_values_07_06_22';
