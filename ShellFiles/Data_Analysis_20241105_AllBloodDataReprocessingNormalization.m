%% 110524_DataAnalysis
% Owner: Taras Hanulia
% Data Type: Blood Cell Data Reprocessing for normalization of raw data
% of the peak
%% Initialization
clear
clc
...
cd(data_path)
T = readtable("TH_20230328_DatasetSummary.xlsx");
...
%     bead_flag = Final_BeadFlag(i);
    output=SamplePeakDetection_PCA_PN_TH_onlynormalization(filepath,file_range,Window_Low,...
