%% 02/28/23 DataAnalysis
% Owner: Nilay Vora
% Data Type: Calibration Measuremnts
% Flow Date: 02/28/2023
%% Experiment Note
% Adjusted 405 pinhole 
%% Initialization
clear
clc
%% Calling Script
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2023\NV_022823_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_02_28_23';
file_range= (1:3);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
