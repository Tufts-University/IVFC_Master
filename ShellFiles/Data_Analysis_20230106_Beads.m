%% 01/06/23 DataAnalysis
% Owner: Nilay Vora
% Data Type: Calibration Measuremnts
% Flow Date: 01/06/2023
%% Experiment Note
% Poor Bead concentration
%% Initialization
clear
clc
%% Calling Script
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2023\NV_010623_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_01_06_23';
file_range= (1:2);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
