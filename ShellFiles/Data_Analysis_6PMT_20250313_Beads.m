%% 03/13/25 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 03/13/2025 
%% Experiment Note
...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2025\TH_031325_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_03_13_25_3_4';
file_range= (3:4);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
