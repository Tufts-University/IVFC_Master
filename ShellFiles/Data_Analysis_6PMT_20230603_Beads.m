%% 06/03/23 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 06/03/2023
%% Experiment Note
% new beads 12mkl
%% Initialization
clear
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2023\6PMT\TH_060323_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_06_03_23';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
