%% 06/10/24 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 06/10/2024 
%% Experiment Note
% beads ND 0.6 on 405 and 633, 1.0 on 488 slit of 405 shorter 
% new ND filter for spactralon 2.3 befor was 3.0
%% Initialization
clear
clc
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2024\TH_061024_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_06_10_24';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
