%% 06/30/24 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 06/30/2024 
%% Experiment Note
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2024\TH_063024_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_06_30_24';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
