%% 03/20/25 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 03/20/2025 
%% Experiment Note
...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2025\TH_032025_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_03_20_25';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
...
files={
    ...
    'NEW_peak_values_03_18_25';...
    'NEW_peak_values_03_20_25'};
