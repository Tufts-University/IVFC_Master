%% 05/04/2023 DataAnalysis
% Owner: Nilay Vora
% Data Type: Calibration Measurements
% Flow Date: 05/04/2023
%% Experiment Note
% Added New beads
%% Initialization
clear
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2023\NV_050423_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%Peak Detection
outputfile= 'NEW_peak_values_05_04_23';
file_range= (1:3);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
