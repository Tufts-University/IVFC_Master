...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2024\TH_111824_Calibration3';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_11_18_24_3';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
...
files={
    ...
    'NEW_peak_values_11_18_24';...
    'NEW_peak_values_11_18_24_2';...
    'NEW_peak_values_11_18_24_3'};
