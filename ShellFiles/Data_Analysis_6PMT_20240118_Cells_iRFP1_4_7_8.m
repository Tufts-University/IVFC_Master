%% 01/22/23 DataAnalysis 
% Owner: Taras Hanulia
% Data Type: Cells   Measurements
% Flow Date: 01/18/2024
%% Experiment Note
% B Cells +iRFP720 Cells1-4 and 7, 8
% Cells in Media
%% Initialization
clear
clc
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Cell\TH_011824_Cell\BCells_iRFP\BiRFP1_4_7_8';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_01_22_23';
file_range= (1:6);
analysisvals=(1:6);
sample_type= 'Cells';
exp_num=[];
