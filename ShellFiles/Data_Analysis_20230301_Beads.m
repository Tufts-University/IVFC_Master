%% 03/01/23 DataAnalysis
% Owner: Nilay Vora
% Data Type: Calibration Measuremnts
% Flow Date: 03/01/2023
%% Experiment Note
% Added New beads
%% Initialization
clear
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2023\NV_030123_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%Peak Detection
outputfile= 'NEW_peak_values_03_01_23';
file_range= (1:2);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
