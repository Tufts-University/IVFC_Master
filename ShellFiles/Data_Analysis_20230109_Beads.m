%% 01/09/23 DataAnalysis
% Owner: Nilay Vora
% Data Type: Calibration Measuremnts
% Flow Date: 01/09/2023
%% Experiment Note
% New Bead stock, 1/4 channel, new alignment
%% Initialization
clear
clc
%% Calling Script
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Nilay\IVFC\Acquired Data\Bead Calibration Data\2023\NV_010923_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_01_09_23';
file_range= (1:2);
analysisvals=(1:3);
sample_type= 'Beads';
exp_num=[];
