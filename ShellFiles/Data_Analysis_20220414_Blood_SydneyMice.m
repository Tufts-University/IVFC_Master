...
%% Experiment Note
% 8 Week Diet Mice: Lean mouse number is 107, 106, 110
%% Initialization
clear
clc
%% Calling Script
...
for i =1:3
    % Labview Conversion
    if i==1
        filepath = 'T:\Nilay\IVFC\Acquired Data\SydneyMice\NV_041422_LeanCancer';
    else
        filepath = ['T:\Nilay\IVFC\Acquired Data\SydneyMice\NV_041422_LeanCancer',num2str(i)];
    end
    Fs=60e3;
    Window_Low= 50;
    Window_High= 6000;
