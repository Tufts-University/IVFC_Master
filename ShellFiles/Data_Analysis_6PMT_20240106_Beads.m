...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2025\TH_010625_Calibration';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_01_06_25';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
