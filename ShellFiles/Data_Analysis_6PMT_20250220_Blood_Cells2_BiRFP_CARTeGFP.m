%% 02/21/25 DataAnalysis 
% Owner: Taras Hanulia
% Data Type: Cells   Measurements
% Flow Date: 02/20/2025
%% Experiment Note
% BiRFP+CARTeGFP Cells in Blood +  beads data with new gain 488-1.9 ,
% 633-2.4 was data 7-12 in lab book
% Cells in Blood
%% Initialization
clear
clc
...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Blood Cell Data\2025\TH_022025_Blood_Cell2';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
