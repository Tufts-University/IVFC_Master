%% 11/19/24 DataAnalysis
% Owner: Taras Hanulia
% Data Type: Beads Calibration 
% Flow Date: 11/19/2024 
%% Experiment Note
...
%% Bead Calibration
% Labview Conversion
filepath = 'R:\Taras\IVFC\Bead Calibration Data\2024\TH_111924_Calibration2';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
% Peak Detection
outputfile= 'NEW_peak_values_11_19_24_2';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
...
%% Calibration
files={
    'NEW_peak_values_11_12_24';...
    'NEW_peak_values_10_30_24';...
    'NEW_peak_values_11_13_24';...
    'NEW_peak_values_11_19_24';...
    'NEW_peak_values_11_19_24_2'};
