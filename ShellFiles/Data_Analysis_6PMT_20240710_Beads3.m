...
% new ND filter for spactralon 2.3 befor new ex ND 3rd run 
%% Initialization
clear
clc
...
%% Bead Calibration
% Labview Conversion
filepath = 'T:\Taras\IVFC\Acquired Data\Bead Calibration Data\2024\TH_071024_Calibration3';
Fs=60e3;
Window_Low= 50;
Window_High= 6000;
...
%%
%Peak Detection
outputfile= 'NEW_peak_values_07_10_24_31';
file_range= (1:2);
analysisvals=(1:4);
sample_type= 'Beads';
exp_num=[];
