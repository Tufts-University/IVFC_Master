function successmessage=SamplePeakDetection6PMTRF_PSE(filepath,outputfile,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% file:SamplePeakDetection6PMTRF_PSE.m
% ***Description***:
...
% function save start and end of the peak, but dont save peak widt and peak
...
% intensity_threshold= 0.2; Currently only used for FLR analysis!
% bead_flag=0;
