function successmessage = BeadSorting_GFP6PMT(filepath, file_range)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% file: BeadSorting_GFP6PMT.m
% ***Description***:
% This function serves to automatically search for Bead Peaks and sort them
...
% when a flag indicates Beads were added to the blood sample.
...
% Latest Revision: 6PMT modification and GFP
% Beads are in channel E2C
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Function details
% Inputs:
%   filepath = Location of the main folder where all subfolders are
%   file_range = Which files to analyze on a specific day
% Outputs:
...
successmessage = 'Completed Separating GFP Bead Peaks';